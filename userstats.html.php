...
<head>
    ...
    <title>User Stats | ExerTracker</title>
...
<!--Load the AJAX API-->
    ...
    <script type="text/javascript">
      ...
      function drawChart() 
	  {
		...
		//set chart options
		var options = {'title':'Exercise Proportions', 'width':1000, 'height':400};
		//instantiate and draw chart and pass in options
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="userdata.php">User Data</a></li>
						   <li class="active"><a href="userstats.php">User Stats</a></li>
