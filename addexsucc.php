...
<head>
    ...
    <title>Type of Exercise Added Successfully | ExerTracker</title>
    ...
    <section id="feature" class="transparent-bg">
        <div class="container">
           <div class="center wow fadeInDown">
                <h2>Type of Exercise Added Successfully!</h2>
          
				<h3>Click <a href="enterdata.php">here</a> to return to the Enter Data page.</h3> 
