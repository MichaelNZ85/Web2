            ...
            <div class="get-started center wow fadeInDown">
                <?php
					if(isset($_SESSION['username']))
					{
						...
						echo "<p class='lead'>Welcome to the <strong>ExerTracker</strong> Website, $uname!</p>";
					}
				  ?>
                <p class="lead">Here you can <a href="enterdata.php">enter exercise data,</a>, track your exercise and see your data displayed using charts, graphs and a calendar.</a>.</p>
