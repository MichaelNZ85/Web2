        ...
        <div class="container">
           <div class="center wow fadeInDown">
			...
			?>
				<table>
					<tr>
						<td>New Exercise Type:</td><td><input type='text' name='newextype' placeholder='Type of Exercise' size='30'></td>
					</tr>
					<tr>
						<td></td><td><input type='submit' name='addex' value='Add Exercise'></td>
					</tr>
				</table>
			</form>	
